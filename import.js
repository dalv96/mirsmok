...
var imprt = async () => {
    ...
    var robots = {
        ...
        'с.Маленькое (Симферопольский район)': ar['ГУС Симферополь'],
        ...
        'Аникеева Екатерина Викторовна': ar['ГУС Севастополь'],
        'Кукинова Ирина Сергеевна': ar['ГУС Севастополь'],
        'пгт. Форос': ar['ГУС Севастополь'],
        'Лисицына Анастасия Сергеевна': ar['ГУС Севастополь'],
        'г. Инкерман (г. Севастополь)': ar['ГУС Севастополь'],

        'г. Ялта': ar['ГУС Ялта'],
        'Яценко Елена Александровна': ar['ГУС Ялта'],
        'пгт. Массандра': ar['ГУС Ялта'],
        'г. Алупка': ar['ГУС Ялта'],
        'Черникова София Михайловна': ar['ГУС Ялта'],
        'пгт. Ливадия': ar['ГУС Ялта'],
        'пгт. Советское (Ялта)': ar['ГУС Ялта']
    };
